...
<script>
    ...
    for (let i = 0; i < roles.length; i++) {
        if (role[i].value === "1") {
            promos[i].hidden = true;
            specialities[i].hidden = true;
            classes[i].hidden = true;
        }
        role[i].addEventListener('change', () => {
            // if user is an admin
            if (role[i].value === "1") {
                promos[i].hidden = true;
                specialities[i].hidden = true;
            ...
            else if (role[i].value === "2") {
                promos[i].hidden = true;
                specialities[i].hidden = false;
                classes[i].hidden = false;
            }
            // if user is an student
            else {
                promos[i].hidden = false;
                specialities[i].hidden = false;
                classes[i].hidden = false;
            }
        });
